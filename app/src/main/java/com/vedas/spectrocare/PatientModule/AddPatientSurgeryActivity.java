...
public class AddPatientSurgeryActivity extends AppCompatActivity implements CallBackTask, MedicalPersonaSignupView {
    private int mHour, mMinute;
    private String format = "";
    EditText edtTime,edtDate,edt_surgeryInfo,ed_doctorName,ed_note;
    ...
    Button btnOk;
    int i,k,j;
    TextView txtHours,txtMin,txtAm,txtPm,txtFilename;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_patient_surgery);
        casting();
        clickListeners();
    ...
    public void casting() {
        refreshShowingDialog=new RefreshShowingDialog(AddPatientSurgeryActivity.this);
        edtDate = findViewById(R.id.edt_start_date);
        edtTime = findViewById(R.id.edt_surgery_time);
        ...
        edt_surgeryInfo=findViewById(R.id.edt_disease_name);
        ed_doctorName=findViewById(R.id.edt_symptoms);
        ...
        /*if(PatientMedicalRecordsController.getInstance().surgeryObjectArrayList.size() ==0){
            Log.e("onResume", "call");
            PatientSurgicalRecordServerObjectDataController.getInstance().addDummyalergiesApi();
        }*/
    }
    @Override
    ...
    private void validations() {
       /* if (edtTime.getText().toString().isEmpty()) {
            ...
            if (isNetworkConnected()) {
                ...
                PatientSurgicalRecordServerObjectDataController.getInstance().addSurgicalCallForAttchmet(false,file,filenmae,
                        ed_note.getText().toString(),ed_doctorName.getText().toString(),edtDate.getText().toString(),edt_surgeryInfo.getText().toString());
            } else {
                refreshShowingDialog.hideRefreshDialog();
    ...
    private void hideKeyboard(EditText editText) {
        InputMethodManager imm = (InputMethodManager)AddPatientSurgeryActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent imageReturnedIntent) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            Toast.makeText(AddPatientSurgeryActivity.this, "Image Capturing Cancelled", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(AddPatientSurgeryActivity.this, "Image Selection Cancelled", Toast.LENGTH_SHORT).show();
    ...
    private void LoadCaptureImageScreen() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(AddPatientSurgeryActivity.this,
    ...
    public void cameraDailog() {
        ...
        AlertDialog.Builder   dialog1 = new AlertDialog.Builder(AddPatientSurgeryActivity.this);
        LayoutInflater   inflater = AddPatientSurgeryActivity.this.getLayoutInflater();
        ...
        cam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(AddPatientSurgeryActivity.this,
        ...
        switch (requestCode) {
            case CAMERA_PERMISSION_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(AddPatientSurgeryActivity.this, "Yay! You Denied Permission", Toast.LENGTH_SHORT).show();
                }
                break;
            ...
            new androidx.appcompat.app.AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(AddPatientSurgeryActivity.this,
    ...
    public void clickListeners() {
        edtDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mView = LayoutInflater.from(AddPatientSurgeryActivity.this).inflate(R.layout.popup_calender_view, null, false);
        ...
        edtTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mView = LayoutInflater.from(AddPatientSurgeryActivity.this).inflate(R.layout.timepicker_layout, null, false);
                popUp = new PopupWindow(mView, LinearLayout.LayoutParams.WRAP_CONTENT,
                        LinearLayout.LayoutParams.WRAP_CONTENT, false);
                popUp.setTouchable(true);
                popUp.setFocusable(true);
    ...
    public void dialogeforCheckavilability(String title, String message, String ok) {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(AddPatientSurgeryActivity.this);
