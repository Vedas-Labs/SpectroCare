...
public class PatientMedicationServerObjectDataController {

    public static PatientMedicationServerObjectDataController myObj;
    Context context;
    public boolean isFromStaring = false;

    public static PatientMedicationServerObjectDataController getInstance() {
        if (myObj == null) {
            myObj = new PatientMedicationServerObjectDataController();
        }
    ...
    public void medicationDeleteApiCall(PatientMedicationRecordModel medicationRecordModel) {
        PatientModel currentMedical = PatientLoginDataController.getInstance().currentPatientlProfile;
