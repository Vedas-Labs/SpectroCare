...
import com.vedas.spectrocare.adapter.ScreeningMedicalAdapter;
...
public class ScreeningRecordForMedicalActivity extends AppCompatActivity implements CallBackTask {
    FloatingActionButton btnScreeningRecord;
    private static final int FILE_PICKER_REQUEST_CODE = 8001;
    ImageView imgFile;
    TextView txtFile,txtMedicScrnDisc;
    ...
    ScreeningMedicalAdapter screeningMedicalAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screening_record_for_medical);
        ...
        txtFile = findViewById(R.id.txt_screen_record_file);
        txtMedicScrnDisc = findViewById(R.id.text_screening_medic_disc);
        showingDialog = new RefreshShowingDialog(ScreeningRecordForMedicalActivity.this);
        gestureDetector = new GestureDetector(this, new SingleTapDetector());
        btnScreeningRecord = findViewById(R.id.btn_screening_medical_record);
        if (isConn()) {
            showingDialog.showAlert();
            MedicalScreeningServerObjectDataController.getInstance().fetchMedicalScreeningRecord();
        }
    ...
    public void onEventMainThread(PhysicalServerObjectDataController.MessageEvent event) {
        ...
        if (resultData.equals("addIllnessScreening")) {
            loadRecyclerView();
    ...
    private void openFilePDF(){
        try{
            ...
            inte.setDataAndType(
                    Uri.parse("http://3.92.226.247:3000/images/MedicalRecords/djDYp1582115389822chandu reddy _Urine Test Report_20190812."),
                    "application/pdf");

            startActivity(inte);
        }catch(ActivityNotFoundException e){
            Log.e("cxcxcx", ""+e.getMessage());
        }
    }
    private void loadRecyclerView() {
        screeningItemList = MedicalScreeningRecordDataController.getInstance().fetchMedicalScreeningData(IllnessDataController.getInstance().currentIllnessRecordModel);
        if(screeningItemList.isEmpty()){
            txtMedicScrnDisc.setVisibility(View.VISIBLE);
        }else {
            txtMedicScrnDisc.setVisibility(View.GONE);
        }
        screeningRecyclerView = findViewById(R.id.screening_medical_recycler_view);
        screeningRecyclerView.setLayoutManager(new LinearLayoutManager(ScreeningRecordForMedicalActivity.this));
        screeningRecyclerView.setHasFixedSize(true);
        screeningMedicalAdapter = new ScreeningMedicalAdapter(ScreeningRecordForMedicalActivity.this, screeningItemList);
        screeningRecyclerView.setAdapter(screeningMedicalAdapter);
    }
            ...
            public void successCallBack(JSONObject jsonObject, String curdOpetaton) {
                if (curdOpetaton.equals("fetch")) {
                    try {
                        ...
                        MedicalScreeningRecordDataController.getInstance().deleteMedicalScreeningData(IllnessDataController.getInstance().currentIllnessRecordModel);
                        if (jsonArray.length() > 0) {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                MedicalScreeningServerObjectDataController.getInstance().processfetchMedicalScreenAddData(userIdentifier, trackArray);
                            }
                        }
                    ...
                    MedicalScreeningRecordDataController.getInstance().deleteScreeningRecordModelData(IllnessDataController.getInstance().currentIllnessRecordModel, MedicalScreeningRecordDataController.getInstance().currentMedicalScreenigRecordModel);
                }
                showingDialog.hideRefreshDialog();
                loadRecyclerView();
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent imageReturnedIntent) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            Toast.makeText(ScreeningRecordForMedicalActivity.this, "Image Capturing Cancelled", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ScreeningRecordForMedicalActivity.this, "Image Selection Cancelled", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ScreeningRecordForMedicalActivity.this, "File Selection Cancelled", Toast.LENGTH_SHORT).show();
        }
    ...
    private void LoadCaptureImageScreen() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(ScreeningRecordForMedicalActivity.this,
    ...
    private void loadFile() {
        ...
        if (isConn()) {
            showingDialog.showAlert();
            MedicalScreeningServerObjectDataController.getInstance().addMedicalScreeningRecord(file, filenmae, ed_moreInfo.getText().toString());
        } else {
        ...
        switch (requestCode) {
            case CAMERA_PERMISSION_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(ScreeningRecordForMedicalActivity.this, "Yay! You Denied Permission", Toast.LENGTH_SHORT).show();
                }
                break;
            ...
            new androidx.appcompat.app.AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(ScreeningRecordForMedicalActivity.this,
    ...
    public void bottomDialogSheet() {
        ...
        attachmentDialog = new BottomSheetDialog(Objects.requireNonNull(ScreeningRecordForMedicalActivity.this), R.style.BottomSheetDialogTheme);
...
// Potentially direct the user to the Market with a Dialog
    ...
    public void cameraBottomSheet() {
        ...
        final BottomSheetDialog cameraBottomSheetDialog = new BottomSheetDialog(Objects.requireNonNull(ScreeningRecordForMedicalActivity.this), R.style.BottomSheetDialogTheme);
        ...
        cam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(ScreeningRecordForMedicalActivity.this,
