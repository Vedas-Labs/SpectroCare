...
import com.vedas.spectrocare.PatientModule.PatientSelfExamActivity;
 ...
 * Use the {@link PatientSelfExamFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PatientSelfExamFragment extends Fragment {
    ...
    public PatientSelfExamFragment() {
     ...
     * @return A new instance of fragment PatientSelfExamFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PatientSelfExamFragment newInstance(String param1, String param2) {
        PatientSelfExamFragment fragment = new PatientSelfExamFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =inflater.inflate(R.layout.fragment_patient_self_exam, container, false);
        patientSelfExamView = v.findViewById(R.id.self_exam_recycle_view);
        PatientSelfExamAdapter selfExamAdapter = new PatientSelfExamAdapter(getContext());
        patientSelfExamView.setLayoutManager(new LinearLayoutManager(getContext()));
        patientSelfExamView.setAdapter(selfExamAdapter);
