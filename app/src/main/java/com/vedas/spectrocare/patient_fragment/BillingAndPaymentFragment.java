...
public class BillingAndPaymentFragment extends Fragment {
     ...
     * @return A new instance of fragment BillingAndPaymentFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView billingRecycle = paymentView.findViewById(R.id.billing_recycle);
        BillingAndPaymentAdapter billingAdapter = new BillingAndPaymentAdapter(getContext());
